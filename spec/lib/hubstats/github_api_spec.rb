  ...
  describe GithubAPI, :type => :model do
    context ".configure" do
      ...
      context "Config File" do
        ...
        it 'should intialize with options param' do
          ...
          expect(Hubstats::GithubAPI.configure({"access_token" => access_token})).to eq(client)
        end
      end
      ...
      context "application authentication" do 
        ...
        it 'should intialize properly' do
          ...
          expect(Hubstats::GithubAPI.configure({"client_id" => "client_id", "client_secret" => "client_secret"})).to eq(client)
        end
      end
      ...
      context "improperly" do
        ...
        it 'should not initialize at all'  do
          expect(lambda { Hubstats::GithubAPI.configure()}).to raise_error Octokit::Unauthorized
        end
      end
    ...
    context ".since" do
      ...
      it 'should get more requests for the earlier date' do
        ...
        earlier_pulls = Hubstats::GithubAPI.since(earlier)
        later_pulls = Hubstats::GithubAPI.since(later)
      ...
      context "multiple pages" do
        ...
        it 'should get 40 pulls' do 
          ...
          pulls = Hubstats::GithubAPI.since(datetime)
