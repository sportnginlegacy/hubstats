...
module Hubstats
  describe Deploy, :type => :model do
    ...
    it 'orders deploys based on timespan ASC' do
      repo = build(:repo)
    ...
    it 'orders deploys based on timespan DESC' do
      repo = build(:repo)
    ...
    it 'should error when not given a git_revision' do
      repo = build(:repo)
    ...
    it 'should error when not given a repo_id' do
      repo = build(:repo)
    ...
    it 'should error when not given a deployed_by' do
      repo = build(:repo)
